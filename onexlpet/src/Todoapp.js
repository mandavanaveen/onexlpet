...
function App() {
  ...
  return (
    <div className="absolute w-full h-screen flex justify-center items-center bg-gradient-to-r from-[#094d79] via-[#18905d] to-[#00d4ff]">
      <div className="font-inter  flex flex-col gap-6 p-5 bg-white rounded-md drop-shadow-xl">
        <h1 className="flex  text-3xl">Todo List Application</h1>
        <h1 className="text-lg">CREATE TASK</h1>
        <div className="flex gap-2">
          <input
            type="text"
            className="w-2/3 h-10 border-[1px] pl-2 rounded-md border-gray-950"
            value={inputValue}
